      ...
      <FadeIn className="h-fit m-auto space-y-4 md:w-1/2">
        <>
          ...
          <div className="m-auto">
            ...
            <Skill width={0.55} i={3} expanded={expanded} setExpanded={setExpanded} label={<FontAwesomeIcon icon={faAws} fontSize="1.5rem" />} />
            <Skill width={0.6} i={4} expanded={expanded} setExpanded={setExpanded} label={<FontAwesomeIcon icon={faGit} fontSize="1.5rem" />} />
            <Skill width={0.85} i={5} expanded={expanded} setExpanded={setExpanded} label={<FontAwesomeIcon icon={faLinux} fontSize="1.5rem" />} />
            <Skill width={0.45} i={6} expanded={expanded} setExpanded={setExpanded} label={<FontAwesomeIcon icon={faGolang} fontSize="1.5rem" />} />
          </div>
        </>
      </FadeIn>
    </div>
